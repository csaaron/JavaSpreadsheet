...
public class DependancyGraph
{
	...
	private HashMap<String, HashSet<String>> dependents;
	...
	{
		dependents = new HashMap<String, HashSet<String>>();
	...
	{
		boolean added;
		added = addKeyAndHashValue(dependents, s, t);
	...
	{
		boolean removed;
		removed = removeKeyAndHashValue(dependents, s, t);
	 ...
	 * corresponding value to the HashSet. If the key does not exist, adds it to
	 * dict, and adds value to its new corresponding HashSet.
	 * 
	...
	/**
	 * Takes two strings, a key and a value. If the key exists, in dict, removes the
	 * corresponding value from the HashSet. If the underlying HashSet becomes
	 * empty, removes the key from dict.
	 * 
	 * Returns true if dict or its underlying values were changed.
	 */
