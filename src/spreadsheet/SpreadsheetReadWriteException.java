...
{
	/**
	 * Constructs a new SpreadsheetReadWriteException with the given message and Throwable
	...
	/**
	 * Constructs a SpreadsheetReadWriteException using the given message. Does not provide
