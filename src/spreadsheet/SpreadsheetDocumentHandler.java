...
public class SpreadsheetDocumentHandler extends DefaultHandler
{
	...
	/**
	 * Returns a HasMap keyed by the cell names and whos values are the contents of
	 * the cells contained in the saved spreadsheet. Map will be empty if parsing
	...
	/**
	 * Returns the version of the saved spreadsheet. Will return an empty string if parsing
	 * has not be completed.
	 */
	...
	/**
	 * Convenience class for storing the name and contents of a cell while parsing a
